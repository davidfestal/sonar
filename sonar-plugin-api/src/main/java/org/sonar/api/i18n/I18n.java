...
public interface I18n extends ServerComponent, BatchComponent {
   ...
   * @param defaultPattern the default pattern returned when the key is not found in any bundle
   ...
   */
  public abstract String translation(final Locale locale, final String key, final String defaultPattern, final Object... parameters);
}
